...
print(Qubit(np.asarray([0.1, 0.1])).is_normalized())
...
print(Gate(np.asarray([[0.5, 0.5], [0.5, 0.5]])).is_own_inverse())
...
print(Gate(np.asarray([[0.5, 0.5], [0.5, 0.5]])).valid_quantum_operation())
